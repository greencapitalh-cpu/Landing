...
export default function Hero() {
  ...
  const bgImage = `/images/bg-en.png`;
    ...
    <>
      ...
      <section className="block md:hidden w-full bg-white">
        ...
        <div className="px-6 pt-4 pb-8 text-center bg-white">
          ...
          <p className="text-gray-600 text-[15px] leading-relaxed">
            Integrates blockchain infrastructure into real-world operations to ensure
            verifiable integrity and traceability.
          </p>
